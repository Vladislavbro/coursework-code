...
- Составные географические названия (например "Техас ( штат , США )") размечай как одну сущность LOC целиком
- Полные имена людей, включая составные фамилии с дефисом, размечай как одну сущность PER целиком
- Сущности нужно извлекать в том падеже, в котором они встречаются в тексте
- Названия спортивных команд, сборных включая полное описание размечай как одну сущность ORG целиком
- В текстах типа "перенаправление [объект] ( [место] )" размечай только географические места, а не сами объекты
- Названия произведений, альбомов, песен размечай как ORG, даже если в тексте есть технические символы
- Исторические регионы размечай как LOC, а не PER
